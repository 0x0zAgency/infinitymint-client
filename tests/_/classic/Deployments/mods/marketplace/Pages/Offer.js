                ...
                <Container className>
                    {!this.state.isValid ? (
                        ...
                        <>
                            <Row className="mt-5">
                                <Col>
                                    <p className="text-center display-1 nikeboiAltText text-white">
                                        My Offers
                                    </p>
                                    <p className="nikeboiAltText fs-2 text-center text-white">
                                        Heres the offers you have sent for a{" "}
                                        {Resources.projectTokenPlural()}
                                    </p>
                                </Col>
                            </Row>
                                                        ...
                                                        <Form.Control
                                                            ...
                                                            className={
                                                                ...
                                                                this.state.token
                                                                    ...
                                                                    Controller
                                                                        .accounts[0]
                                                                    ? "text-center border-2 border-dark"
                                                                    : "text-center border-2 border-success"
                                                            }
                                                            onChange={(e) => {
                                                                this.setState({
                                                                    offerPrice:
