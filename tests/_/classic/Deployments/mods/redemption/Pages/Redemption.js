...
class Redemption extends Component {
    ...
    async requestToken() {
        ...
        let cypherKey = Config.sets[this.state.phraseId];
        ...
        await Controller.sendMethod(
            ...
            'Mod_Redemption',
            'requestToken',
            [this.state.tokenId, encoded, encodedKey]
        );
    ...
    async attemptDisplayOfToken() {
        ...
        this.state.checks[this.state.tokenId] = await this.getChecks();
                            ...
                            <Row className="mt-2">
                                ...
                                <Col lg>
                                    ...
                                    <p className="fs-5 text-white">
                                        Manage passcode redemption of your{' '}
                                        {Resources.projectToken()} here!
                                    </p>
                                    {/* <Card body>
                    <Card.Title>About these 👟</Card.Title>
                  </Card> */}
