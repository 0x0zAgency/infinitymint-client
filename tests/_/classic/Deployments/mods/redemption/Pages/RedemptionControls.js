        ...
        return (
            <Container className="p-5" fluid>
                <Row className="text-white">
                    <Col>
                        <h1 className="fs-1 nikeboiAltText text-white">
                            🏷️ Redemption Controls{" "}
                            <span className="badge bg-dark text-white display-5">
                                {this.state.deploymentAddress}
                            </span>
                        </h1>
                        <p className="fs-3">
                            Manage passcode redemption of your ERC721 tokens
                            here
                        </p>
                    </Col>
                </Row>
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        token?.noPhrase ===
                                                                                            ...
                                                                                            <Spinner
                                                                                                ...
                                                                                                className="ms-3 m-2 mt-4 d-none d-lg-block d-xl-block"
                                                                                            />
                                                                                        )}
                                                                                    </Col>
                                                                                    <Col>
