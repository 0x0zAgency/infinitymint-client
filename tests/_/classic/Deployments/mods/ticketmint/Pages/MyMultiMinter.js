...
MyMultiMinter.id = "MintMultiMinter";
MyMultiMinter.url = "/multiminter/:multiMinterContract";
MyMultiMinter.settings = {};
export default MyMultiMinter;
